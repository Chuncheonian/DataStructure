...
int Application::InsertItem() {     // case 1
	ItemType item;
	cin >> item;
...
void Application::DisplayAll() {    // case 2
	ItemType data;
...
int Application::RetrieveItem() {   // case 4
	ItemType item;
...
int Application::DeleteItem() {     // case 5
	ItemType item;
