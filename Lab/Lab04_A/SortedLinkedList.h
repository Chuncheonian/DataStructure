...
public:
	...
	void operator=(SortedLinkedList& _item);
};
...
template <typename T>
void SortedLinkedList<T>::GetNextItem(T& _item) {
...
template <typename T>
int SortedLinkedList<T>::Add(T _item) {
	ResetList();	// 리스트 초기화
...
template <typename T>
int SortedLinkedList<T>::Delete(T _item) {
...
template <typename T>
int SortedLinkedList<T>::Get(T& _item) {
	bool moreToSearch, found;
...
template <typename T>
int SortedLinkedList<T>::Replace(T _item) {
	bool moreToSearch, found;
	NodeType<T>* location;	// 변수 선언
...
template<typename T>
void SortedLinkedList<T>::operator=(SortedLinkedList& _item) {
	MakeEmpty();
