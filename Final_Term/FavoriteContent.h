...
public:
  ...
  FavoriteContent(MultimediaContent &_mc) {
    SetName(_mc.GetName());
    SetTime(_mc.GetTime());
  ...
  /**
	 ...
	 * @param	_data	target FavoriteContent for assigning.
	 */
  void operator=(const FavoriteContent &_data);

  /**
	 * @brief	Compare corresponding condition in two FavoriteContent class
	 * @pre		Two FavoriteContent class should be initialized.
	 * @post	None.
	 * @param	_data	target FavoriteContent for comparing.	
	 * @return	Return true If Two member variables corresponding Condition are the same, Otherwise return false.
	 */
  bool operator==(const FavoriteContent &_data);

  /**
	 * @brief	Compare two FavoriteContent by member variable corresponding Condition.
	 * @pre	    Two FavoriteContent should be initialized.
	 ...
	 */
  bool operator<(FavoriteContent &_data);
   ...
   * @param   _data   target FavoriteContent for printing.
   */
  friend ostream &operator<<(ostream &cout, const FavoriteContent &_data) {
