...
public:
  ...
  void SetRecord(string _contentName, int _contentType, string _createTime, string _character, string _location, string _eventName) {
...
//   void DisplayConditionOnscreen() { cout << "\tCondition(1. createTime, 2. contentName, 3. viewNumber): " << m_condition; }
  ...
  friend istream& operator>>(istream& cin, MultimediaContent& _item) {
    ...
    cout << "\tEnter content type(ex> 1: Music, 2: Photo, 3: Video):";
