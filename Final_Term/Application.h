...
private:
  ...
  BinarySearchTree<MultimediaContent>       m_masterList;         // Multimedia Content List.
  
  SortedList<FavoriteContent>               m_favoriteMusicList;  // Favorite Music Content List.
  SortedList<FavoriteContent>               m_favoritePhotoList;  // Favorite Photo Content List.
  SortedList<FavoriteContent>               m_favoriteVideoList;  // Favorite Video Content List.
...
public:
  ...
  //  * @return  Return 1 if this funcion works well, Oterwise return 0.
  //  */
